...
with cte1 as (SELECT COUNT(DISTINCT sender_id, send_to_id) as requests FROM FriendRequest),
 cte2 as (SELECT COUNT(DISTINCT requester_id, accepter_id) as accepts
FROM RequestAccepted)

SELECT ifnull(round(cte2.accepts/cte1.requests, 2),0) as accept_rate FROM cte1, cte2
